...
#print('1')
#print(labels_cid)
counter = Counter(labels_cid)
sorted_occurrences_labels_cid = list(dict(sorted(counter.items())).values())
#print(sorted_occurrences_labels_cid)
print(len(sorted_occurrences_labels_cid))
...
#print('2')
#print(labels_cid_3char)
counter = Counter(labels_cid_3char)
sorted_occurrences_labels_cid_3char = list(dict(sorted(counter.items())).values())
#print(sorted_occurrences_labels_cid_3char)
print(len(sorted_occurrences_labels_cid_3char))
...
l_dense = TimeDistributed(Dense(units=gru_output_size))(l_gru) # 3D vector shape (?,400,175)
...
#model.compile(loss=[categorical_class_balanced_focal_loss(n_instances_per_class=np.array(sorted_occurrences_labels_cid), beta=0.9, gamma=2.),
#                    categorical_class_balanced_focal_loss(n_instances_per_class=np.array(sorted_occurrences_labels_cid_3char), beta=0.9, gamma=2.),
#                    'binary_crossentropy'],
#                    optimizer='adam', 
#                     metrics=['accuracy', 'f1score', 'precision', 'recall'], loss_weights = [0.8 , 0.85, 0.75])
...
#model.compile(loss=['categorical_crossentropy','categorical_crossentropy',categorical_class_balanced_focal_loss(n_instances_per_class=np.array(sorted_occurrences), beta=0.9, gamma=2.)], optimizer='adam', 
 #            metrics=['accuracy'], loss_weights = [0.8, 0.85, 0.75])
#%%
